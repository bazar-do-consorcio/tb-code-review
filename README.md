...
- [Documentation](https://docs.coderabbit.ai) - Documentação completa que abrange todos os aspectos do CodeRabbit.
- [Blog](https://www.coderabbit.ai/blog) - Blog oficial com atualizações, tutoriais e boas práticas.
- [FAQ](https://www.coderabbit.ai/faq) - Perguntas frequentes sobre o CodeRabbit.
- [GitHub Repository](https://github.com/coderabbitai/ai-pr-reviewer) - Repositório oficial do AI PR Reviewer.
- [LinkedIn](https://www.linkedin.com/company/coderabbitai/) - LinkedIn.
- [Twitter](https://x.com/coderabbitai) - Twitter/X.
- [YouTube Channel](https://www.youtube.com/@CodeRabbitAI) - YouTube.

## Getting Started

- [AI Code Reviewer Examples](https://www.coderabbit.ai/blog/how-to-use-an-ai-code-reviewer-on-github-in-4-examples) - Quatro exemplos práticos de utilização do CodeRabbit..
...
# Default: ""
tone_instructions: "Forneça feedback construtivo e educacional em português brasileiro focando em web3, segurança de smart contracts, qualidade de código e boas práticas de React/TypeScript. Seja específico sobre problemas e sugira soluções práticas."
...
reviews:
  ...
  path_instructions:
    ...
    - path: "**/*.sol"
      instructions: |
        Para contratos inteligentes Solidity:
        - Priorize segurança: verifique ataques comuns como reentrância, overflow/underflow, acesso não autorizado
        - Use padrões como Checks-Effects-Interactions
        - Implemente eventos para mudanças significativas de estado
        - Considere otimização de gas
        - Use OpenZeppelin para funcionalidades padrão
        - Documente funções públicas/externas com NatSpec
        - Implemente modificadores para validações comuns

    # Scripts JavaScript/Node.js
    - path: "**/*.js"
      instructions: |
        Para código JavaScript:
        - Siga o Standard.js (sem ponto e vírgula, aspas simples, indentação de 2 espaços)
        - Use async/await em vez de promises quando apropriado
        - Implemente tratamento adequado de erros
        - Evite funções anônimas inline em loops
        - Use destructuring quando apropriado
        - Prefira const sobre let quando possível

    # Arquivos AWS SAM e CloudFormation
    - path: "**/*.yaml"
      instructions: |
        Para templates AWS SAM/CloudFormation:
        - Valide todas as referências de recursos e parâmetros
        - Use Outputs para expor recursos necessários
        - Implemente políticas IAM com princípio do menor privilégio
        - Configure variáveis de ambiente adequadamente
        - Use CloudFormation intrinsic functions corretamente
        - Documente recursos complexos com comentários

    # Componentes Next.js/React JSX
    - path: "**/*.jsx"
      instructions: |
        Para componentes React/Next.js:
        - Use componentes funcionais com hooks
        - Implemente prop-types para validação de props
        - Use useEffect corretamente (evite vazamentos de memória)
        - Prefira componentes controlados
        - Implemente error boundaries quando apropriado
        - Use lazy loading e Suspense para performance
        - Aplique princípios de acessibilidade (a11y)
        
    # Componentes Next.js/React TSX
    - path: "**/*.tsx"
      instructions: |
        Para componentes React/Next.js com TypeScript:
        - Use componentes funcionais com hooks
        - Defina interfaces/types para props e estado
        - Use useEffect corretamente (evite vazamentos de memória)
        - Prefira componentes controlados
        - Implemente error boundaries quando apropriado
        - Use lazy loading e Suspense para performance
        - Aplique princípios de acessibilidade (a11y)
        - Use tipagem estrita e evite any
        - Prefira interfaces para props de componentes

    # Configurações Hardhat
    - path: "**/hardhat.config.js"
      instructions: |
        Para configurações Hardhat:
        - Valide configurações de rede e provedores
        - Configure corretamente os caminhos de contratos e artefatos
        - Use variáveis de ambiente para chaves privadas e secrets
        - Configure plugins necessários adequadamente
        - Defina limites de gas apropriados
        - Configure verificação de contratos quando aplicável
  ...
  tools:
    ...
    slither:
      ...
      # Enable Slither - Slither is a static analysis tool for Solidity smart contracts - v0.10.4
      # Default: true
      enabled: true

      # Command line arguments to pass to Slither
      # Default: []
      args: ["--exclude-dependencies", "--exclude-informational"]
